      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 shadow-lg">
            <h3 className="font_5 text-gray-900 mb-8 text-center">
              Why Choose Us?
            </h3>
            ...
            <div className="space-y-6">
              {reasons.map((reason, index) => (
                <div key={index} className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font_7 text-gray-900 mb-2">
                      {reason.title}
                    </h4>
                    <p className="font_9 text-gray-600 leading-relaxed">
                      {reason.description}
                    </p>
                  </div>
                </div>
            ...
            <div className="mt-8 p-4 bg-primary-50 border-l-4 border-primary-600">
              <p className="font_8 text-primary-800 text-center">
          ...
          <div className="bg-white p-8 shadow-lg">
                        ...
                        <div key={valueIndex}>
                          {info.links[valueIndex] ? (
                            <a
                              ...
                              className="font_8 text-primary-600 hover:text-primary-700 transition-colors"
                            >
                              {value}
                            </a>
                          ) : (
                            <span className="font_8 text-gray-600">
                              {value}
                            </span>
                          )}
                        </div>
            ...
            <div className="mt-8 space-y-4">
              <a
                ...
                className="block w-full bg-primary-600 hover:bg-primary-700 text-white text-center py-4 px-6 font_7 transition-colors duration-300"
              >
                Call Now for Free Quote
              </a>
              <a
                href="mailto:contact@prolaserdxb.com"
                className="block w-full bg-gray-600 hover:bg-gray-700 text-white text-center py-4 px-6 font_7 transition-colors duration-300"
              >
                Send Email Inquiry
              </a>
            </div>
